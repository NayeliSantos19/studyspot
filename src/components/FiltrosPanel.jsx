    ...
    <div className="fixed inset-0 z-50 bg-paper flex flex-col">
      <div className="max-w-md w-full mx-auto px-5 pt-6 pb-3 flex items-center gap-3 flex-shrink-0">
        <button
          onClick={onClose}
          aria-label="Cerrar"
          className="w-9 h-9 rounded-xl bg-white border border-neutral-200 flex items-center justify-center"
        >
      ...
      <div className="max-w-md w-full mx-auto px-5 py-5 border-t border-neutral-200 flex-shrink-0">
        <button
          onClick={onApply}
          className="w-full bg-accent text-paper rounded-xl py-3.5 font-semibold text-[15px]"
        >
          Aplicar filtros
        </button>
      </div>
